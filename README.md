...
**Schemat** is an object-oriented platform for building scalable internet applications composed of [isomorphic](https://en.wikipedia.org/wiki/Isomorphic_JavaScript) **web objects** that can easily move over the network and execute in any local environment (on client, server, or data node). 
