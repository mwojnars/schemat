...
export class Ring extends WebObject {
    ...
    async rebuild_indexes() {
        ...
        // await this.main_sequence.rebuild_derived()
...
export class Database extends WebObject {
    ...
    async execute(inserts = null, updates = null, deletes = null, opts = {}) {
        /* Called by Session to perform a batch of mutations of mixed types. Arguments:
    ...
    async create_aggregation(name, key, sum = [], {category, ring} = {}) {
        return this._create_derived(schemat.std.AggregationOperator, {name, key, sum, category}, {ring})
    }
