...
export class Monitor {
    ...
    derive_ops(key, prev, next, checked = true) {
        ...
        return this.dst.bind_ops(ops)       // in each op, append info about the destination block
    }
}
...
export class DataBlock extends Block {
    ...
    _cascade_delete(prev, next = null) {
        ...
        // TODO: check if prev.__category.member_schema has any strong REFs at all (via a cached getter) to avoid traversing __data if possible
