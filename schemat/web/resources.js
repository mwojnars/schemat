...
export class Resources {
    ...
    `
        ...
        <!--<script src="/system/local/schemat/assets/libs/react.production.min.js" integrity="sha256-Ipu/TQ50iCCVZBUsZyNJfxrDk0E2yhaEIz0vqI+kFG8=" crossorigin="anonymous"></script>
            <script src="/system/local/schemat/assets/libs/react-dom.production.min.js" integrity="sha256-nbMykgB6tsOFJ7OdVmPpdqMFVk4ZsqWocT6issAPUF0=" crossorigin="anonymous"></script>-->
        
        <script src="/system/local/schemat/assets/libs/react.development.js" crossorigin="anonymous"></script>
        <script src="/system/local/schemat/assets/libs/react-dom.development.js" crossorigin="anonymous"></script>
        ...
        <!-- Material UI -->
        <script src="/system/local/schemat/assets/libs/material-ui_v5.2.6.development.min.js" crossorigin></script>
        ...
        <!-- local resources... -->
        <script src="/system/local/schemat/assets/libs/peg-0.10.0.min.js" crossorigin></script>

        <!--<script src="/system/local/schemat/assets/libs/popper.min.js" crossorigin></script>-->
        <link href="/system/local/schemat/assets/favicon.ico" rel="icon" type="image/x-icon" />
        <link href="/system/local/schemat/assets/styles.css" rel="stylesheet" />
    `
