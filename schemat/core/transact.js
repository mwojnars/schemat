    ...
    */
    ...
    get_mutable(obj) {
        ...
        if (existing?.__meta.edits.length) return existing
            ...
            // else throw new Error(`unsaved raw edits exist for ${obj} and the remote object cannot be edited further`)
            // // never return remote objects created in stage_edits(), they have no __data and cannot be used for further edits
